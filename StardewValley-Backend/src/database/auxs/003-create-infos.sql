...
INSERT INTO Estação (nome, descricao) VALUES
...
INSERT INTO Item (id_tipo) VALUES ('Semente'),
('Ferramenta'),
('Consumivel'),
('Arma'),
('Vestimenta'),
...
INSERT INTO Local_Fechado ( id_tipo) VALUES ('Caverna');
('Loja'),
('Cabana-NPC'),
('Cabana-Jog');

INSERT INTO Mundo (nome) ('Fazenda'), ('Vale');

INSERT INTO Arma (nome, descricao, dano, finalidade) VALUES ('Espada', 'Arma balanceada', 3, 'Atacar monstros'),
...
INSERT INTO Artesanato (nome, descricao) VALUES ('Espatantalho', 'Evita que corvos ataquem suas plantações. Tem um raio limitado (cerca de 8 espaços).'),
...
INSERT INTO Consumivel (nome, descricao) VALUES ('Omelete', 'Superfofinha.'),
('Salada', 'Uma saudável salada de jardim.'),
('Avelãs torradas', 'O processo de torra dá um rico sabor de floresta.'),


INSERT INTO Ferramenta (nome, descricao, finalidade) VALUES ('enxada', 'Usada principalmente para preparar o solo para arar o solo e para escavar os pontos de artefatos.', 'Cultivo'),
...
INSERT INTO VESTIMENTA (nome, descricao) VALUES ('Chapéu de Abóbora', 'Um chapéu de abóbora assustador perfeito para o Festival do Vale da Colheita.'),
...
INSERT INTO Monstro ( nome, descricao, dano, item_drop, defesa, saude_maxima) VALUES ('Carangejo-pedra', 'Caranguejo-Pedra é um inimigo encontrado em As Minas.', 5, 'Bombinha', 1, 30),
('Fantasma', 'Fantasmas são inimigos encontrado em nas Minas.', 10, 'Quartzo refinado', 3, 96),
('Serpente', 'Serpente é um inimigo encontrado Caverna da Caveira.', 10, 'Bomba', 0, 150);

INSERT INTO Monstro ( nome, descricao, dano, item_drop, defesa, saude_maxima) VALUES ('Carangejo-pedra', 'Caranguejo-Pedra é um inimigo encontrado em As Minas.', 5, 'Bombinha', 1, 30),
('Fantasma', 'Fantasmas são inimigos encontrado em nas Minas.', 10, 'Quartzo refinado', 3, 96),
('Serpente', 'Serpente é um inimigo encontrado Caverna da Caveira.', 10, 'Bomba', 0, 150);

INSERT INTO Semente (estacao, nome ,descricao, valor_venda, dias_para_crescer) VALUES (1, 'Semente de Couve-flor','Plante-as na primavera. Demora 12 dias para produzir uma couve-flor grande.',40, 12),
...
INSERT INTO Missao (estacao , nome, descricao) VALUES (1, 'Plantando as Sementes','O prefeito Lewis pede a você para plantar 10 sementes de parsnip. Ele lhe dará as sementes necessárias e recompensará você por concluí-la.'),
...
INSERT INTO Regiao (mundo, nome) VALUES (1, 'Estufa'), (1, 'Caverna'), (1, 'Casa da Fazenda'), (1, 'Lavouras'),
(2, 'Vila Pelicanos'), (2, 'Floresta Cinzaseiva'), (2, 'Praia'), (2, 'Montanha');
...
(2, 1, 2, 'Aventureiros do Abismo', 'Uma loja que vende equipamentos e suprimentos para aventureiros da Caverna.'),
(2, 2, 2, 'Mercadoria das Profundezas', 'Uma loja misteriosa na Caverna operada por Krobus, que vende itens exclusivos.'),
(2, 3, 5, 'Loja de Pesca do Willy', 'Uma loja de artigos de pesca à beira da Vila Pelicanos, operada por Willy.'),
(2, 4, 6, 'Loja de Linus', 'Uma modesta loja de suprimentos na cabana de Linus na Floresta Cinzaseiva.');
...
(1, 1, 1), -- Receita para criar uma Semente
(2, 1, 10), -- Receita para criar uma Ferramenta
(3, 2, 5), -- Receita para criar Mudas de Grama
(4, 3, 1), -- Receita para criar um Tear
(5, 4, 4), -- Receita para criar Piso Rustico de Tabuas
(6, 5, 1); -- Receita para criar um Cristalario
...
(4, 1, 3, 'Cabana do Edilberto', 'Uma pequena cabana aconchegante na Casa da Fazenda de Edilberto.'),
(4, 2, 6, 'Refúgio de Marcus', 'Uma cabana tranquila na Floresta Cinzaseiva, onde Marcus encontra serenidade.'),
(4, 3, 8, 'Retiro de Matheus', 'Uma cabana isolada nas Montanhas, onde Matheus aprecia a solidão.'),
