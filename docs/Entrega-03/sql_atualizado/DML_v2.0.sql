...
INSERT INTO Arma (nome, descricao, dano, finalidade, comeca_jogo_com) VALUES 
('Espada', 'Arma balanceada', 3, 'Atacar monstros', TRUE),
('Adaga', 'Arma mais rápida de curto alcance', 2, 'Atacar monstros', FALSE),
('Clava', 'Arma mais lenta de longo alcance', 5, 'Atacar monstros', TRUE),
('Estilingue', 'Arma de longo alcance, sem contato', 6, 'Atacar monstros', FALSE);
